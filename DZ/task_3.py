...
class Cell:
    ...
    def __str__(self):
        return f'Клетка, состоящая из {self.quantity}'

    def __add__(self, other):
        return f'Сумма клеток = ({self.quantity + other.quantity})'

    def __sub__(self, other):
        sub_quant = self.quantity - other.quantity
        if sub_quant > 0:
            return f'Разность клеток = ({sub_quant})'
        else:
            return 'Pазность отрицательна, поэтому операция не выполняется'
